        ...
        <div className="grid items-center gap-8 lg:grid-cols-2">
          <div className="space-y-6">
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              <button className="inline-flex items-center justify-center gap-2 rounded-full bg-white px-5 py-3 font-semibold text-emerald-800 shadow-md">
                Ver catálogo
                <FiArrowRight />
              </button>
              <button className="rounded-full border border-white/20 bg-white/5 px-5 py-3 font-semibold text-white">
                Saiba mais
              </button>
            </div>
